...
export function Modal({ isOpen, onClose, title, children, accentColor }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 touch-none">
      ...
      <div className="relative bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl border border-gray-700 p-4 sm:p-6 w-full max-w-sm sm:max-w-md max-h-[90vh] overflow-y-auto shadow-lg touch-auto overflow-x-hidden">
        <div
